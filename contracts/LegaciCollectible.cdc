...
pub contract LegaciCollectible: NonFungibleToken {
    ...
    init() {
        ...
        self.account.save<@Collection>(<- create Collection(), to: /storage/LegaciCollectibleCollection)

        // Create a public capability for the Collection
        self.account.link<&{LegaciCollectibleCollectionPublic}>(/public/LegaciCollectibleCollection, target: /storage/LegaciCollectibleCollection)

        // Put the Minter in storage
        self.account.save<@Admin>(<- create Admin(), to: /storage/LegaciCollectibleAdmin)
